...
def display_available_exercise(user_id, selected_theme):
    """
    ...
    exercises_filtered = exercises_filtered.sort_values("last_reviewed").reset_index(drop=True)
...
with st.sidebar:
    ...
    current_exercise = exercise_selected[exercise_selected["exercise_name"] == exercise_name_selected].iloc[0]
